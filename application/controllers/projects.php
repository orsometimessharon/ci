...
public function __construct(){
    ...
    if(!$this->session->userdata('logged_in')){
        $this->session->set_flashdata('no_access','Sorry youll have access only then logged in');
        redirect('home/index');
    };
}
...
public function index(){
   ...
   public function create (){
    ...
    $this->form_validation->set_rules('project_name', 'Projects Name', 'trim|required');    
    $this->form_validation->set_rules('project_body', 'Description', 'trim|required');
